...
function updatePositions() {
  ...
  // Added array for values of i%5 from original code so that i%5 wouldn't need to be recalculated over and over again.
  for (var i = 0; i < 5; i++) {
...
// Changed number of pizzas generated to 25.
